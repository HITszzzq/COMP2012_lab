...
HD_PWD='F:/CPUDesign/mycpu_board_200111130/mycpu_board_200111130.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rib.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rib.tcl
