...
HD_PWD='F:/CPUDesign/mycpu_board_200111130/mycpu_board_200111130.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rib.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rib.tcl -notrace
